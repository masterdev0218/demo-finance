import { administrationRouteNavigate } from './../../../features/administration-managment/administration-managment-route';
...
import {
  logoutUser,
  logoutMicrosoft,
} from '../../../features/login/store/user.action';
...
export class HeaderComponent {
  ...
  administrationRouteNavigate = signal(administrationRouteNavigate);
